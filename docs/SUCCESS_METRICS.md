...
|---|---|---|---|---|---|---|
| M-001 | Debug APK builds successfully | 1 pass | 1 pass | `./gradlew assembleDebug` | done | EV-021 |
| M-002 | Unit tests pass | 100% | 100% | `./gradlew testDebugUnitTest` | done | EV-019 |
| M-003 | Lint passes with zero errors | 0 errors | 0 errors | `./gradlew lint` | done | EV-021 |
